    ...
    return (<div style={{ marginTop: '1em' }}>
        ...
        <Row>
            <Col>
                ...
                <p style={{ marginLeft: '4em', marginRight: '4em', fontSize: '14pt' }}>
                    За допомогою слайдера ви можете збільшувати/зменшувати зображення. На боковій панелі ви можете вказати всі параметри трикутника. Для найкращого результату використовуйте рівнобедренні трикутники розміщені щонайближче до центру координатної площини. Завантажити модифіковае зображення можна скориставшис опцією "Завантажити файл"
                </p>
            </Col>
        </Row>
    </div >);
